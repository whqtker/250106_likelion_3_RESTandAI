...
import { mockChats } from '../mocks/data.js'
...
function ChatRoom() {
    ...
    const fetchInitialMessages = async () => {
        try {
            const response = await axios.get(`http://localhost:8040/api/v1/chat/rooms/${roomId}/messages`)
    ...
    const connectWebSocket = () => {
        try {
            const ws = new WebSocket(`ws://localhost:8040/ws/chat/${roomId}`)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (connected && wsRef.current) {
                ...
                await axios.post(`http://localhost:8040/api/v1/chat/rooms/${roomId}/messages`, {
                    content: newMessage,
                    author: authorName,
                })
            }
