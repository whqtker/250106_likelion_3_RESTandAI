...
import { mockChatRooms } from '../mocks/data.js'
...
function ChatRoomList() {
    ...
    const fetchChatRooms = async () => {
        try {
            const response = await axios.get('http://localhost:8040/api/v1/chat/rooms')
    ...
    const handleCreateRoom = async (e) => {
        ...
        try {
            setCreating(true)
            await axios.post('http://localhost:8040/api/v1/chat/rooms', {
                name: newRoomName,
            })
            setNewRoomName('')
